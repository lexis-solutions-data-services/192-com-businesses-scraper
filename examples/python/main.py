"""
Example: How to call the 192-com-businesses-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/192-com-businesses-scraper
...
def run_actor():
    """Run the 192-com-businesses-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/192-com-businesses-scraper"
